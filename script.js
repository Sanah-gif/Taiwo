...
const projects = [
    {
        ...
        image: 'assets/images/project-ecommerce.jpeg', // ← replace .svg with your real image
    ...
    },
    {
        ...
        image: 'assets/images/project-portfolio.jpeg', // ← replace with your image
        tags: ['HTML', 'CSS', 'JavaScript'],
        link: '#'
    },
    {
        ...
        image: 'assets/images/project-mobile.jpeg',    // ← replace with your image
        tags: ['HTML', 'CSS', 'JavaScript'],
        link: '#'
    }
];
...
footerCopy.textContent = '© ' + new Date().getFullYear() + ' Taiwo. All rights reserved.';
